...
wd="/home/groups/CEDAR/mulqueen/projects/nmt/nmt_test/redo_bams/methylated_regions"
...
#SBATCH --time=3:00:00 ## ask for 1 hour on the node 
#SBATCH -- 
srun Rscript /home/groups/CEDAR/mulqueen/src/cistopic_methylation.R %s %s %s %s' "${reg[i]}" "${c_type[i]}" "${name[i]}" $wd > "cistopic.${c_type[i]}.${name[i]}.slurm.sh"  ; done
